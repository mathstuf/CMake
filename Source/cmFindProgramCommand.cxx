...
std::string cmFindProgramCommand::FindProgram(std::vector<std::string> const& names)
{
  std::string program = "";
...
std::string cmFindProgramCommand::GetBundleExecutable(std::string const& bundlePath)
{
