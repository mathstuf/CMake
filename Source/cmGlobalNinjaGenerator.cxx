...
void cmGlobalNinjaGenerator::OpenBuildFileStream()
{
  ...
  if (!this->BuildFileStream)
    {
    this->BuildFileStream = new cmGeneratedFileStream(buildFilePath);
    if (!this->BuildFileStream)
      {
...
void cmGlobalNinjaGenerator::OpenRulesFileStream()
{
  ...
  if (!this->RulesFileStream)
    {
    this->RulesFileStream = new cmGeneratedFileStream(rulesFilePath);
    if (!this->RulesFileStream)
      {
      // An error message is generated by the constructor if it cannot
      // open the file.
                                      ...
                                      const std::string &sourceFile)
{
  ...
  if (!this->CompileCommandsStream)
    ...
    this->CompileCommandsStream =
      new cmGeneratedFileStream(buildFilePath);
    *this->CompileCommandsStream << "[";
    } else {
